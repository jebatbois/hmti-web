...
// --- GROUP ADMIN ---
// Filter 'auth' = Wajib Login (Semua Role)
$routes->group('admin', ['filter' => 'auth'], function($routes) {
    
    // 1. AREA UMUM (Bisa Admin & Editor)
    $routes->get('dashboard', 'Admin\Dashboard::index');
    $routes->get('/', 'Admin\Dashboard::index');

    // Manajemen Berita (Semua bisa)
    ...
    // CRUD INTERAKSI (Pesan & Mimbar) - Semua bisa
    ...
    // 2. AREA KHUSUS ADMIN (PROTECTED)
    // Kita bungkus lagi dengan group filter 'adminOnly'
