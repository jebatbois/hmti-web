    ...
    <div class="container mx-auto px-6">
        ...
        <div class="max-w-xl mx-auto mb-12">
            <form action="" method="get" class="relative">
                <!-- Input: name="keyword" sesuai dengan controller -->
        ...
        <?php if($berita) : ?>
            ...
            <div class="mt-12 flex justify-center">
                <div class="pagination-custom">
                    <!-- Kirim parameter keyword ke link pagination juga agar tidak reset saat ganti halaman -->
...
<!-- CSS Fix untuk Pagination Default CI4 -->
<style>
